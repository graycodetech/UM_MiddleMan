                        ...
                        <?php else: ?>
                            <?php foreach ($transactions as $txn): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php $sms_status_class = strtolower($txn['sms_status'] ?? 'pending'); ?>
                                        <div class="sms-ticks status-<?php echo $sms_status_class; ?>" title="SMS Status: <?php echo htmlspecialchars(ucfirst($sms_status_class)); ?>"></div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
